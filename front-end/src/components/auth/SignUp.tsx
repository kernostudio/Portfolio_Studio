      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left space-y-6 animate-fade-in">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-black leading-tight">
            Create Amazing Portfolios
          </h2>

          <p className="text-xl text-gray-800 max-w-lg mx-auto lg:mx-0 leading-relaxed">
            Join thousands of creators building stunning portfolios with our
            templates. Customize with simple edits and publish instantly. No
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 w-full max-w-md border border-white/50 animate-slide-up">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">Join Portfolio Studio today</p>
            </div>
