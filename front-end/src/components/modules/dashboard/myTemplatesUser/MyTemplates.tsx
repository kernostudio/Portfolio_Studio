      ...
      html: `
        <div class="text-left">
          ...
          <div class="mb-4">
            ...
            <select id="domainType" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-1 focus:ring-gray-500 focus:border-gray-500">
          ...
          <div class="mb-4">
            ...
            <input 
              id="domain" 
              class="w-full p-3 border border-gray-300 rounded-lg focus:ring-1 focus:ring-gray-500 focus:border-gray-500" 
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
        ...
        <div className="flex justify-between border-t pt-3">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-xs text-black hover:bg-gray-50 rounded-lg transition-colors"
          >
  ...
  if (isError) {
    return (
      <div className="text-center min-h-screen py-12">
        ...
        <button
          onClick={() => refetch()}
          className="mt-4 bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors"
        >
          Try Again
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8 flex justify-between items-center mt-4 bg-white rounded-lg p-4 border border-gray-200">
          <div>
          ...
          <div>
            <span className="hidden sm:block font-bold text-xl px-4 py-2 rounded-2xl bg-gray-200">
              {templates?.length || 0}
            </span>
          </div>
        </div>
